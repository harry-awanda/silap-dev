...
@if(session('warningimport'))
<div id="toastImportWarning" class="bs-toast toast fade bg-danger position-absolute m-3 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <!-- Bagian header dari toast -->
  <div class="toast-header">
    <!-- Ikon kesalahan -->
    <i class="bx bx-error me-2"></i>
  ...
  <div class="toast-body">{{ session('warningimport') }}</div>
</div>
@endif

<!-- Menampilkan toast untuk pesan kesalahan import jika ada sesi 'errorimport' -->
@if(session('errorimport'))
<div id="toastImportError" class="bs-toast toast fade bg-warning position-absolute m-3 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <!-- Bagian header dari toast -->
  <div class="toast-header">
    <!-- Ikon kesalahan -->
